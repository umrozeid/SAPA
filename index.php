...
<div id="top-div" class="d-flex flex-column justify-content-center align-items-center">
    <div>
        <p class="top-div-text-1 mb-3 mx-1 text-center">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
        <p class="top-div-text-2 mx-1 text-center">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
    </div>
</div>
<!--    About Us Section-->
<div id="aboutUs">
    <div class="container-md" id="AU">
        ...
        <div class="row align-items-center justify-content-center">
            ...
            <div class="col-12 col-md-8">
                <p class="text-center">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur justo turpis,
                    interdum dignissim tortor non, vestibulum iaculis justo. Donec non nisl malesuada, malesuada eros
                    ac, tempor felis. Cras ac urna nulla. Vivamus convallis vel risus porttitor tincidunt. Suspendisse
                    in diam ut ante cursus suscipit. Fusce cursus eu velit in venenatis. Mauris porttitor tortor ipsum,
                    sit amet volutpat augue accumsan nec.</p>
            </div>
            <div class="col-12" style="padding-top: 1%;">
                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur justo turpis, interdum dignissim
                    tortor non, vestibulum iaculis justo. Donec non nisl malesuada, malesuada eros ac, tempor felis.
                    Cras ac urna nulla. Vivamus convallis vel risus porttitor tincidunt. Suspendisse in diam ut ante
                    cursus suscipit. Fusce cursus eu velit in venenatis. Mauris porttitor tortor ipsum, sit amet
                    volutpat augue accumsan nec.</p>
            </div>
        </div>
        <div id="poly-div"></div>
    </div>
...
<div class="container-md mt-5" id="AC">
    ...
    <div class="row align-items-center">
        <div class="col-12 col-md-4 d-flex flex-column align-items-center justify-content-center">
            ...
            <p class="text-center achievements-text">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur
                justo turpis, interdum dignissim tortor non, vestibulum iaculis justo.</p>
        </div>
        <div class="col-12 col-md-4 d-flex flex-column align-items-center justify-content-center">
...
<div class="container-md mt-5" id="JU">
    ...
    <div class="row align-items-center justify-content-center">
        <div class="col-12 col-md-8">
            ...
            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur justo turpis, interdum dignissim
                tortor non, vestibulum iaculis justo.Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur
                justo turpis, interdum dignissim tortor non, vestibulum iaculis justo.</p>
